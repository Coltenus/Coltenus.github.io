export default class UserView {
    ...
    displayLinks1(id) {
        ...
        links.insertAdjacentHTML('beforeend', `<br><div class="container rounded bg-color-3 box-1">
            <p>To logout press <button href="register.html" class="btn fg-color-3" id="logout-button">this button</button></p>
            </div>`);
    ...
    displayLinks2(id, page) {
        let email = this.userModel.getEmail();
        let links = document.getElementById(id);
        links.insertAdjacentHTML('beforeend', `<a class="plc-1 nav-item nav-link" href="profile.html">${email.substring(0, email.indexOf("@"))}</a>`);
